...
class Ui_settingsForm(object):
    def setupUi(self, settingsForm):
        ...
        settingsForm.resize(410, 360)
        settingsForm.setMinimumSize(QtCore.QSize(410, 360))
        settingsForm.setMaximumSize(QtCore.QSize(410, 360))
        settingsForm.setBaseSize(QtCore.QSize(410, 360))
        icon = QtGui.QIcon()
        ...
        self.pushClose.setGeometry(QtCore.QRect(300, 320, 90, 28))
        self.pushClose.setObjectName("pushClose")
        self.pushOK = QtWidgets.QPushButton(settingsForm)
        self.pushOK.setGeometry(QtCore.QRect(200, 320, 90, 28))
    ...
    def retranslateUi(self, settingsForm):
        ...
        self.pushOK.setText(_translate("settingsForm", "OK"))
