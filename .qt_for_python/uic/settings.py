...
class Ui_settingsForm(object):
    def setupUi(self, settingsForm):
        ...
        self.checkAuthBox = QtWidgets.QCheckBox(self.proxyBox)
        self.checkAuthBox.setGeometry(QtCore.QRect(20, 130, 171, 21))
        self.checkAuthBox.setObjectName("checkAuthBox")
    ...
    def retranslateUi(self, settingsForm):
        ...
        self.checkAuthBox.setText(_translate("settingsForm", "Proxy Authentication"))
